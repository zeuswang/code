#ifndef _SOGOU_UTILS_H_
#define _SOGOU_UTILS_H_
#include <string>
#include <sys/time.h>
#include <stdlib.h>
#include <map>
...
#define SS_USE_DEPRECATED_MD5_FUNCS 1
...
std::string UrlEncode(const std::string& encode);
std::string UrlDecode(const std::string& decode);
